...
public final class WalletGrpc {
  ...
  private static final int METHODID_GET_DELEGATED_RESOURCE = 63;
  private static final int METHODID_GET_DELEGATED_RESOURCE_ACCOUNT_INDEX = 64;
  private static final int METHODID_LIST_PROPOSALS = 65;
  private static final int METHODID_GET_PAGINATED_PROPOSAL_LIST = 66;
  private static final int METHODID_GET_PROPOSAL_BY_ID = 67;
  private static final int METHODID_LIST_EXCHANGES = 68;
  private static final int METHODID_GET_PAGINATED_EXCHANGE_LIST = 69;
  private static final int METHODID_GET_EXCHANGE_BY_ID = 70;
  private static final int METHODID_GET_CHAIN_PARAMETERS = 71;
  private static final int METHODID_GET_ASSET_ISSUE_LIST = 72;
  private static final int METHODID_GET_PAGINATED_ASSET_ISSUE_LIST = 73;
  private static final int METHODID_TOTAL_TRANSACTION = 74;
  private static final int METHODID_GET_NEXT_MAINTENANCE_TIME = 75;
  private static final int METHODID_GET_TRANSACTION_SIGN = 76;
  private static final int METHODID_GET_TRANSACTION_SIGN2 = 77;
  private static final int METHODID_CREATE_ADDRESS = 78;
  private static final int METHODID_EASY_TRANSFER = 79;
  private static final int METHODID_EASY_TRANSFER_BY_PRIVATE = 80;
  private static final int METHODID_GENERATE_ADDRESS = 81;
  private static final int METHODID_GET_TRANSACTION_INFO_BY_ID = 82;
